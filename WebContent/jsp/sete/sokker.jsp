...
<head>
	...
	<script type="text/javascript" src="${sessionScope.base}js/sokker.js"></script>	
...
<body onload="carga();">
	...
	<div style="display:inline-block; vertical-align: top; background-color: #e2f2f8; padding: 1px;">
		<div style="display:inline-block; vertical-align: top">
			<c:if test="${empty sessionScope.ilogin}">
				<form action="${sessionScope.base}Login" method="post">
					Login <input type="text" name="ilogin">
					<br/>
					Password <input type="password" name="ipassword">
					<br/>
					<input type="submit" />
					<br/>
		...
		<form action="http://sokker.org/tactedit.php" method="get">
		...
		<div style="display:inline-block; vertical-align: top">
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="250" height="380" id="tactica" align="">
				<param name="movie" value="http://sokker.org/UstawienieStats2.swf"> 
				<param name="quality" value="high"> 
				<embed src="http://sokker.org/UstawienieStats2.swf" quality="high" width="300" height="450" name="UstawienieEdycjaPost" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer">
			</object>
	...
	<div style="display:inline-block; vertical-align: top; background-color: #4f8ea2; padding: 1px;">
		...
		<div style="display:inline-block">
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="250" height="380" id="tactica_" align="">
				<param name="movie" value="http://sokker.org/UstawienieStats2.swf"> 
				<param name="quality" value="high"> 
				<embed src="http://sokker.org/UstawienieStats2.swf" quality="high" width="300" height="450" name="UstawienieEdycjaPost" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer">
			</object>
		...
		<div style="display:inline-block; vertical-align: top;">
			...
			<div style="font-size: small; vertical-align: bottom; text-align: center">
				<a href="http://www.formulamanager.com">
					Powered by<br/>
					<img src="http://www.formulamanager.com/img/logo.png" width="100" align="middle" />
				</a>
			</div>
		</div>
	</div>
...
<%-- 
http://sokker.org/read_tact.php?id=2137686
http://sokker.org/tactedit.php?id=2137686&save=1&tact=
 --%>
</body>
</html>
