...
public class GrupoBO {
	public static List<Grupo> crear_grupos(List<Integer> lista_ids, Integer equipos_grupo, Integer num_jornadas, boolean doble_vuelta) throws FailingHttpStatusCodeException, MalformedURLException, IOException {
