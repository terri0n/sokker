...
public class Competicion {
	...
	public Competicion(List<Integer> lista_ids, Integer equipos_grupo, Integer num_jornadas, int equipos_champions, int equipos_uefa, Integer equipos_cp, boolean doble_vuelta) throws FailingHttpStatusCodeException, MalformedURLException, IOException {
		...
		grupos = GrupoBO.crear_grupos(lista_ids, equipos_grupo, num_jornadas, doble_vuelta);
		competiciones = new ArrayList<Grupo>();
