...
public class Equipo {
	public enum TIPO_COMPETICION { CHAMPIONS, UEFA, OTROS("Copa Perdedores");
	...
	public static Equipo DESCANSO = new Equipo("DESCANSO", null, null, null);
	...
	public static Equipo nuevo(Integer tid, WebClient navegador) {
		try {
			XmlPage pagina = navegador.getPage("http://sokker.org/xml/team-" + tid + ".xml");
