...
public class PCliga extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		formularioLogin.getInputByName("login").setValueAttribute(getLogin());
		formularioLogin.getInputByName("pass").setValueAttribute(getPassword());
	...
	public static String getLogin() {
		try {
			...
			return (String) initialContext.lookup("java:comp/env/pcliga_login");
	...
	public static String getPassword() {
		try {
			Context initialContext = new InitialContext();
			return (String) initialContext.lookup("java:comp/env/pcliga_password");
		} catch (NamingException e) {
			e.printStackTrace();
			throw new RuntimeException(e);
		}
